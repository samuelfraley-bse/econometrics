...
confidenceEllipse(fit, which.coef = c("x3", "x4"), 
                  ...
                  col = "blue",
                  lwd = 2,
                  fill = TRUE,           # Add shading
                  fill.alpha = 0.2)      # Transparency level (0-1)
...
# Add legend with proper formatting - use bquote for the last entry
legend("topright", 
       legend = c("Joint 95% CR", "Individual 95% CIs", "Estimate", 
                  "H0: β3 = β4 = 0"),
