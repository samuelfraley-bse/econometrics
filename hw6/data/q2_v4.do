...
save "att_estimates_by_treatment.dta", replace
export delimited "att_estimates_by_treatment.csv", replace
...
use "att_estimates_by_treatment.dta", clear
...
graph export "att_estimates_by_treatment_plot.png", replace width(2400) height(1600)