...
\begin{enumerate}[label=(\alph*)]
  ...
  \begin{scriptsize}
    \verbatiminput{tables/probit.log}
  \end{scriptsize}
  ...
  Be specific about possible sources
...
\begin{enumerate}[label=(\alph*), resume]
  ...
  \begin{scriptsize}
\verbatiminput{tables/firststage.log}
\end{scriptsize}

\begin{scriptsize}
\verbatiminput{tables/ivprobit.log}
\end{scriptsize}
