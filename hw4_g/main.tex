...
\end{table}
  ...
  \textcolor{red}{It represent all the pair of values $\{x_i, y_i\}$ such that the joint test $H_0 : \beta_3 = x_i , \: \beta_4 = y_i;\:\: H_1 : $ No $H_0$, won't be rejected at a confidence level $95\%$.}
\textcolor{blue}{It represents every combination of the two parameters that falls in the 95\% confidence region.} It also illsutrates the
